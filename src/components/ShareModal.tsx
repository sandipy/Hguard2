    ...
    >
      <div className="bg-slate-900 border-2 border-slate-700 max-w-xl w-full rounded-[2px] shadow-2xl p-5 sm:p-6 text-white flex flex-col gap-5 my-8">
        ...
        <div className="bg-slate-950 border border-slate-800 p-4 rounded-[2px] flex flex-col gap-3">
          ...
          {/* Quick QR Code Instant Pairing Button */}
          <div className="pt-2.5 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-2.5 bg-slate-900/50 p-2.5 rounded-[2px]">
            <div className="flex items-center gap-2">
              <div className="p-1.5 bg-emerald-500/20 text-emerald-400 rounded-[2px] border border-emerald-500/30">
                <QrCode className="w-4 h-4" />
              </div>
              <div className="text-left">
                <div className="text-xs font-black text-white flex items-center gap-1.5">
                  <span>Zero-Setup QR Code Auto-Pair</span>
                  <span className="bg-emerald-400 text-slate-950 text-[9px] font-black uppercase px-1.5 rounded-[2px]">
                    Fastest
                  </span>
                </div>
                <div className="text-[11px] text-slate-400">
                  Scan this QR code with the old camera phone to link instantly without typing
                </div>
              </div>
            </div>

            <button
              id="open-pairing-qr-modal-from-share-btn"
              type="button"
              onClick={() => {
                if (onOpenPairingQR) {
              ...
              className="w-full sm:w-auto px-3.5 py-2 bg-emerald-500 hover:bg-emerald-400 active:bg-emerald-600 text-slate-950 font-black text-xs rounded-[2px] flex items-center justify-center gap-1.5 transition shadow"
            >
              <QrCode className="w-4 h-4" />
