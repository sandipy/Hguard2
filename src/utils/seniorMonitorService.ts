...
export class SeniorMonitorService {
   ...
   * Listens for "Help!", "Help me!", "I fell!", "Emergency!" without pressing buttons in any supported language.
   */
  public startVoiceHelpListener(
    onAlertCallback?: (alert: SeniorAlertData) => void
  ) {
